// Code generated by protoc-gen-go-pact-sample. DO NOT EDIT.
// versions:
// - protoc-gen-go-pact-sample v1.2.0
// - protoc             v3.14.0
...
// is compatible with the pact-sample package it is being compiled against.
...
// It's only intended for direct use with pact-sample.RegisterService,
